  ...
  <div id="aCoursesList" class="bg-fa of">
    ...
    <section class="container">
      ...
      <section class="path-wrap txtOf hLh30">
        ...
        \
        <a href="#" class="c-333 fsize14">后端开发</a>
        \
        <a href="#" class="c-333 fsize14">Java</a>
      </section>
      <!-- /课程所属分类 结束 -->
      ...
      <div>
        <article class="c-v-pic-wrap" style="height: 357px;">
          <section id="videoPlay" class="p-h-video-box">
            <img src="~/assets/photo/course/01.jpg" alt="30天搞定Java核心技术" class="dis c-v-pic">
          </section>
        </article>
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section class="c-attr-mt c-attr-undis">
              <span class="c-fff fsize14">主讲：宋红康&nbsp;&nbsp;&nbsp;</span>
            </section>
          ...
          <ol class="thr-attr-ol">
            <li>
              ...
              <aside>
                ...
                <br>
                <h6 class="c-fff f-fM mt10">100</h6>
              </aside>
            </li>
            <li>
              <p>&nbsp;</p>
                      ...
                      <menu id="lh-menu" class="lh-menu mt10 mr10">
                        <ul>
                          ...
                          <li class="lh-menu-stair">
                            <a title="第一章" href="javascript: void(0)" class="current-1">
            ...
            <div>
              ...
              <section class="stud-act-list">
                <ul style="height: auto;">
                  <li>
                    <div class="u-face">
                      <a href="/teacher/1" target="_blank">
                        <img src="~/assets/photo/teacher/01.jpg" width="50" height="50" alt>
                      </a>
                    </div>
                    <section class="hLh30 txtOf">
                      <a href="/teacher/1" class="c-333 fsize16 fl" target="_blank">宋红康</a>
                    </section>
                    <section class="hLh20 txtOf">
                      <span class="c-999">尚硅谷高级讲师</span>
                    </section>
                  </li>
                </ul>
              </section>
